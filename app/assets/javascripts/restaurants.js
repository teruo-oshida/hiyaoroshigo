...
restaurants.setScore = function(score){
  ...
  var selected = '<span class="sake-selected-star">' + star + '</span>';
  var deselected = '<span class="sake-deselected-star">' + star + '</span>';
  for(var i=1;i<=5;i++)text+=i<=score?selected:deselected;
